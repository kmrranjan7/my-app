...
export const metadata: Metadata = {
  ...
  description: "Browse the latest government exam, result, and admit card updates.",
};
  ...
  return (
    <main className="w-full py-4">
      <section className="mx-auto w-full max-w-[920px] rounded-2xl border border-indigo-100 bg-gradient-to-b from-white to-indigo-50/35 p-4 shadow-[0_16px_32px_rgba(15,23,42,0.08)] ring-1 ring-indigo-50 sm:p-6">
        <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-indigo-600">Updates</p>
        <h1 className="mt-1 text-xl font-black tracking-tight text-slate-900 sm:text-2xl">Latest Updates</h1>
